              ...
              {paged.map((n) => (
                <div
                  ...
                  className={`flex items-start gap-4 p-4 transition-colors ${
                    !n.read ? 'bg-blue-50/40 dark:bg-blue-900/10' : 'bg-white dark:bg-zinc-900/50'
                  }`}
                >
                  <span className={`mt-0.5 shrink-0 inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium ${TYPE_STYLES[n.type]}`}>
                    {n.type}
                  </span>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 mt-1.5">
                      ...
                      {n.link && (
                        <Link href={n.link} className="text-xs text-[#089ec3] hover:underline">
                          View
                        </Link>
                      )}
                    </div>
